...
export default function ProjectPage() {
    return (
        <div className=" z-0 bg-top w-full 2xl:h-[2000px] sm:h-[1800px]  bg-cover bg-[url('../public/outrun-long.png')]">
            <div><Header /></div>
            <div className='absolute top-[600px] 2xl:top-[720px]'>
                ...
                <div><WeatherLink /><FrogFightLink /></div>
